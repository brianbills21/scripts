...
# and it's a thing of beauty. The script called generate-weekly-diskspace-usage.sh reads    #
# files the generated by this scipt and then generates and final weekly diskspace usage     #
