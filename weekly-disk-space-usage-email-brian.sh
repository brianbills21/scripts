...
#############################################################################################
# find-top-5-disk-space-users.sh runs on 4 different servers and is kicked off by a cron    #
# daemon each week. It finds the top 5 disk space users accross 4 different development     #
# hosts and generates "$HOSTNAME"_top_5_per_workspace_$TODAY.csv. The script can be run on  #
# multiple hosts. The find command is used in conjunction with awk and it's a thing of      # 
# beauty. The script called:                                                                #
#                                                                                           #
# generate-weekly-disk-space-usage-report.sh                                                #
#                                                                                           #
# reads files that are generated by find-top-5-disk-space-users.sh and then generates the   # 
# final weekly usage report that gets emailed to the devops managers by this script called: # 
#                                                                                           #
