...
# a thing of beauty. The script called generate-weekly-diskspace-usage.sh reads the files generated by this scipt and then generates and final weekly diskspace usage report that gets emailed to the devops managers by                                                                    #
###########################################################################################
